...
> The author assumes no responsibility for financial loss or damages.

# Cross-DEX Arbitrage Bot

A configurable cross-DEX arbitrage framework for monitoring, testing, and evaluating price inefficiencies across EVM-compatible chains.

This repository supports:

- Local fork-based testing (Hardhat)
- Mainnet monitoring
- Spread detection
- Profitability simulation
- Optional flash-loan execution

The project can be used purely for research and monitoring.
...
- [Alchemy](https://www.alchemy.com/) (Blockchain Connection - RPC Provider)
- [Balancer](https://balancer.fi/) (Flash Loan Provider)
- [Uniswap V3](https://docs.uniswap.org/contracts/v3/overview) (Exchange example)
- [Pancakeswap V3](https://docs.pancakeswap.finance/) (Exchange example)

## Requirements For Initial Setup
- Install [NodeJS](https://nodejs.org/en/). I recommend using the latest LTS (Long-Term-Support) version, and preferably installing NodeJS via [NVM](https://github.com/nvm-sh/nvm#intro).
...
Before running any scripts, you'll want to create a .env file with the following values (see .env.example): Do not commit this file.
